...
/**
 * Step 3.1b Scenario test (RN provider set): Offer construction
 ...
 * boundary per the doc comment above).
 *
 * Mirrors `sdk-providers-web/test/scenarios/offerConstruction.test.ts` exactly,
 * confirming that the same flows work identically on both provider sets.
 */

describe('Offer construction end-to-end (Step 3.1b, RN provider set)', () => {
