 ...
 * specific, any implementation satisfies it). Identical to the web
 * harness's copy of this file — no browser dependency in either, so
 * nothing RN-specific was needed here either. Built on `viem` rather than
