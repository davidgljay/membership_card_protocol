...
import type { CardVerifier, CardVerificationResult } from '../verification/index.js';
import type { AppSignedSubCardDocument } from './requestSubCard.js';
...
export interface HandleSubCardRequestOptions {
  ...
  /** The raw, received request — an `AppSignedSubCardDocument` (Step 4.1's output), untrusted until this function returns `{ valid: true }`. */
  request: AppSignedSubCardDocument;
}
