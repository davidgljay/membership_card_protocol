 ...
 * `btoa`, or `atob` — none of which React Native/Hermes guarantees as a
 * global. Used wherever a value must cross a JSON-string bridge to a
 * native module (react-native-keychain's string-only storage,
 * react-native-passkey's WebAuthn-JSON wire format).
 */
