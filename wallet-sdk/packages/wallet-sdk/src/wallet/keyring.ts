...
export interface KeyringEntry {
  /** keccak256 address the entry's private key corresponds to, hex (no 0x prefix, matching app-sdk's `keccak256`'s output shape). */
  cardAddress: string;
 ...
 * self-contained-blob shape App SDK's `hpke.ts` response envelope uses.
 */
