import { canonicalize } from '@membership-card-protocol/app-sdk';
 ...
 * callback — App SDK's `WalletAppCardIdentity` already satisfies this
 * shape structurally, and a `SecureKeyProvider`-backed sub-card key can be
