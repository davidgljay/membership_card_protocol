...
import type { StorageProvider, SignedTargetedOffer, SignedOpenCardOffer } from '@membership-card-protocol/app-sdk';
import type { ApprovedTargetedOffer, ApprovedOpenOffer } from '../../src/offers/offerVerification.js';

const callOrder = vi.hoisted(() => [] as string[]);

vi.mock('@membership-card-protocol/app-sdk', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@membership-card-protocol/app-sdk')>();
  return {
    ...actual,
