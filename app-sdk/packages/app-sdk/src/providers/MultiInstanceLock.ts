 ...
 * (OQ-SDK-8).
 *
 * On web, two tabs may share the same `StorageProvider`-backed state; this
 * lock prevents them from independently consuming the same UUID from a pool
 * or racing a shared-state update against each other. Not applicable on
