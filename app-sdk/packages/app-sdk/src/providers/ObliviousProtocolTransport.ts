 ...
 * call (account creation, `service_secret` retrieval, custody-management
 * operations, sub-card registration/deregistration, UUID
 ...
 *
 * Implemented once, in this package (pure HTTP + HPKE — no
