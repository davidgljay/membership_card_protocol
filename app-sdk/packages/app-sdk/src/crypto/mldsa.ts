 ...
 *
 * Used by Wallet SDK's custody-restoration flow to reconstruct a card's
 * public key from a private key recovered out of wallet-side durable
 * storage, whose stored entries carry only the private key, not the
 * corresponding public key — the public key was already in scope,
 * freshly generated, at the point the private key was first stored.
 */
