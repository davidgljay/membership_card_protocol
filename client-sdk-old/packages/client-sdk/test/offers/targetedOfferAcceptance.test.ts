...
} from '../../src/offers/targetedOfferAcceptance.js';
...
describe('targeted offer acceptance and press finalization (Step 3.6)', () => {
  it('end-to-end: offerer creates + forwards, recipient reviews + countersigns, press finalizes — completed card carries all three signatures, recipient holds the SCIP', async () => {
    ...
    // --- Recipient reviews and countersigns (Steps 3.2–3.3), against their
