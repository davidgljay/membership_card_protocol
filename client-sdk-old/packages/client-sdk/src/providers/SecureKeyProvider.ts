 ...
 *
 * See `wallet_backup_and_recovery.md` (Secure Enclave/TPM custody for the
 * device sub-card key) and `subcards.md §Sub-Card Key Management`
 * (non-exportability and attestation-tier requirements this interface's
