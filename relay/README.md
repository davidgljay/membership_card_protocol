...
**This codebase is superseded by [`relay-next/`](../relay-next/README.md).**
...
It has been fully replaced by `relay-next/`'s serverless architecture
...
current, authoritative spec, and [`relay-next/README.md`](../relay-next/README.md)
